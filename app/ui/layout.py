...
def main():
    ...
    st.sidebar.markdown("""
        ### Описание проекта
        **Logo Checker** - это инструмент для проверки изображений на наличие логотипов и их ошибок. 
        Загрузите изображение, и модель классификации ONNX определит возможные ошибки на логотипах.
